...
```python
try:
    result = await client.feedback.getAbuseReports(entityId=entityId, entityType=entityType, id=id, pageId=pageId, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getAttributes(pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getAttribute(slug=slug)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getComments(entityType=entityType, id=id, entityId=entityId, userId=userId, pageId=pageId, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.checkEligibility(entityType=entityType, entityId=entityId)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getMedias(entityType=entityType, entityId=entityId, id=id, type=type, pageId=pageId, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getReviewSummaries(entityType=entityType, entityId=entityId, id=id, pageId=pageId, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getReviews(entityType=entityType, entityId=entityId, id=id, userId=userId, media=media, rating=rating, attributeRating=attributeRating, facets=facets, sort=sort, active=active, approve=approve, pageId=pageId, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getTemplates(templateId=templateId, entityId=entityId, entityType=entityType)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getQuestionAndAnswers(entityType=entityType, entityId=entityId, id=id, userId=userId, showAnswer=showAnswer, pageId=pageId, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
...
```python
try:
    result = await client.feedback.getVotes(id=id, refType=refType, pageNo=pageNo, pageSize=pageSize)
    # use result
except Exception as e:
    print(e)
```
